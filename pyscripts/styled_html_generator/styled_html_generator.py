...
from styles import code_styles
...
MAIN_SCRIPT_FILE = STATIC_DIR / 'script.js'
...
def markdown_to_html(markdown_text):
    extra = ExtraExtension(exclude=['attr_list'])
    return markdown.markdown(markdown_text, extensions=[ extra, 'toc', 'nl2br','sane_lists'])
